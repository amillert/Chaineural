...
var logger = helper.getLogger('enrollAdmin');
function main() {
    return __awaiter(this, void 0, void 0, function () {
        var _i, _a, org, orgCapitalized, ccpPath, ccpJSON, ccp, caInfo, caTLSCACerts, ca, walletPath, wallet, adminExists, enrollment, identity, error_1;
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    ...
                    org = _a[_i];
                    if (!(org.lastIndexOf('org', 0) === 0)) return [3 /*break*/, 5];
                ...
                case 2:
                    ...
                    return [3 /*break*/, 5];
                case 3: return [4 /*yield*/, ca.enroll({ enrollmentID: 'admin', enrollmentSecret: 'adminpw' })];
                case 4:
                    enrollment = _b.sent();
                    identity = fabric_network_1.X509WalletMixin.createIdentity(orgCapitalized + "MSP", enrollment.certificate, enrollment.key.toBytes());
