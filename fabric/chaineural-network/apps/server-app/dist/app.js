...
var App = /** @class */ (function () {
    ...
    ;
    App.prototype.getAllAnchorPeersObjects = function () {
    ...
    ;
    App.prototype.getAllCertificateAuthoritiesUrls = function () {
        var configObj = helper.getConfigObject();
        var ca = [];
    ...
    ;
    App.prototype.getAllOrgsMspids = function () {
        var configObj = helper.getConfigObject();
        var orgsMspids = [];
    ...
    ;
    App.prototype.getAllPeers = function () {
        var peers = [];
    ...
    App.prototype.getAllChannels = function () {
        return helper.getAllChannels();
    };
    App.prototype.getPeerForChannel = function (channelName) {
        return this.getAllPeers().map(function (a) { return a.getName(); });
    };
    App.prototype.getAdminCredentialsForOrg = function (mspid) {
        var configObj = helper.getConfigObject();
        var credentials = ['', ''];
        for (var _i = 0, _a = Object.values(configObj.organizations); _i < _a.length; _i++) {
            var orgValue = _a[_i];
    ...
    App.prototype.getChannelsBlockchainInfo = function (channels) {
    ...
    App.prototype.getChannelBlocksHashes = function (channelName, amount, peer, userOrg) {
        return __awaiter(this, void 0, void 0, function () {
    ...
    App.prototype.getChannelAnchorPeers = function (channelName) {
        return __awaiter(this, void 0, void 0, function () {
    ...
    App.prototype.getChannelConnections = function (channelName) {
        return __awaiter(this, void 0, void 0, function () {
    ...
    App.prototype.getChannelInstantiatedChaincodes = function (channelName) {
        return __awaiter(this, void 0, void 0, function () {
    ...
    App.prototype.getInstalledChaincodes = function (peer, type, org) {
        return __awaiter(this, void 0, void 0, function () {
            var users, username;
            return __generator(this, function (_a) {
    ...
    App.prototype.invokeChaincode = function (peerOrgPairs, channelName, chaincodeName, fcn, args, username, peer, fromOrg) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
    ...
    App.prototype.enrollAdminsOnAllCA = function () {
        return __awaiter(this, void 0, void 0, function () {
    ...
    App.prototype.getAdminCreateIfNotExist = function () {
        return __awaiter(this, void 0, void 0, function () {
    ...
    App.prototype.initEpochsLedger = function () {
        return __awaiter(this, void 0, void 0, function () {
    ...
    App.prototype.makeRandomString = function () {
        var outString = '';
