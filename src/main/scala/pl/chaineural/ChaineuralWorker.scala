...
//      log.info(f"[worker]: Loss = $Loss%1.8f")
      ...
      self ! BackwardPass(amountOfDataMiniBatches, x, y, z1, a1, z2)

    case BackwardPass(amountOfDataMiniBatches: Int, x: M, y: M, z1: Matrices, a1: Matrices, z2: Matrices) =>
